...
export function CampaignHero({
  ...
  // Story 12.9 AC5 — shared stale-combat guard hook. Gates "enter active
  // session" behind a confirmation when the session's been idle > 4h.
    ...
    <div className="bg-card border border-white/[0.04] rounded-xl p-4 space-y-3">
      ...
      {!briefingMode && (
        <CampaignStatusCards
          ...
          onOpenCombat={staleGuard.requestOpenCombat}
          onInvite={() => setInviteOpen(true)}
        />
      )}
      ...
      {/* Epic 12 Story 12.9 AC5 — stale-combat guard. State/behavior owned
          by `useStaleSessionGuard`; this just mounts the portal. */}
      <StaleSessionConfirm
