...
export const ACTIONS: ActionEntry[] = [
  ...
  {
    id: "attack",
    icon: React.createElement(SrdIconCrossedSwords, { className: "w-5 h-5" }),
  ...
  {
    id: "cast-a-spell",
    icon: React.createElement(SrdIconSparkle, { className: "w-5 h-5" }),
  ...
  {
    id: "dash",
    icon: React.createElement(SrdIconRun, { className: "w-5 h-5" }),
  ...
  {
    id: "disengage",
    icon: React.createElement(SrdIconFlip, { className: "w-5 h-5" }),
  ...
  {
    id: "dodge",
    icon: React.createElement(SrdIconShield, { className: "w-5 h-5" }),
  ...
  {
    id: "help",
    icon: React.createElement(SrdIconHandshake, { className: "w-5 h-5" }),
  ...
  {
    id: "hide",
    icon: React.createElement(SrdIconEyeOff, { className: "w-5 h-5" }),
  ...
  {
    id: "ready",
    icon: React.createElement(SrdIconClock, { className: "w-5 h-5" }),
  ...
  {
    id: "search",
    icon: React.createElement(SrdIconSearch, { className: "w-5 h-5" }),
  ...
  {
    id: "use-an-object",
    icon: React.createElement(SrdIconBackpack, { className: "w-5 h-5" }),
  ...
  // ─── Reactions ─────────────────────────────────────────────────
  {
    ...
    icon: React.createElement(SrdIconLightning, { className: "w-5 h-5" }),
  ...
  {
    id: "readied-action",
    icon: React.createElement(SrdIconStopwatch, { className: "w-5 h-5" }),
  ...
  {
    id: "movement",
    icon: React.createElement(SrdIconFootprints, { className: "w-5 h-5" }),
  ...
  },
  {
    ...
    icon: React.createElement(SrdIconDoor, { className: "w-5 h-5" }),
  ...
  {
    id: "communicate",
    icon: React.createElement(SrdIconSpeech, { className: "w-5 h-5" }),
