...
- [ ] **Task 11: Onboarding Wizard — Step Icons**
  ...
  - Action: Define a step-to-icon mapping:
    ...
    const STEP_ICONS: Record<number, string> = {
      1: "/art/icons/scroll.png",       // Create campaign = unfurling a scroll
      2: "/art/icons/potion.png",        // Add players = preparing the party
      3: "/art/icons/sword.png",         // Build encounter = ready for battle
      4: "/art/icons/d20.png",           // Share link = roll for initiative!
    };
    ```
...
- [ ] **Task 12: Favicon from Pixel Art D20**
  - File: `app/icon.png` — copy the d20 icon from `public/art/icons/d20.png` (or a 32x32 version) as the app favicon
  - Action: Next.js App Router supports `app/icon.png` as automatic favicon. Simply place a 32x32 PNG of the d20 die there.
  - Notes: This replaces the default Next.js favicon. The d20 pixel art icon reinforces brand identity in the browser tab.
