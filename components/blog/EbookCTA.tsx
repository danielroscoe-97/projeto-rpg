  ...
  if (variant === "banner") {
    return (
      <div className="my-12 rounded-xl border border-gold/20 relative overflow-hidden">
        ...
        <div className="absolute right-[-40px] top-[-30px] bottom-[-30px] w-[340px] pointer-events-none">
          <Image
            ...
            aria-hidden="true"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#13131E] via-[#13131E]/60 to-transparent" />
        </div>
