...
const RACES: RaceSummary[] = [
  ...
  },
  {
    ...
    keyTraitPt: "Ancestralidade Férica",
  },
  {
    slug: "halfling",
    nameEn: "Halfling",
  ...
  },
  {
    ...
    keyTraitPt: "Versatilidade em Perícias",
  },
  {
    slug: "half-orc",
    nameEn: "Half-Orc",
    ...
    keyTraitPt: "Resistência Incansável",
  },
  {
    slug: "tiefling",
    nameEn: "Tiefling",
...
const LABELS = {
  ...
  "pt-BR": {
    title: "Raças D&D 5e",
    subtitle:
      "Todas as 9 raças SRD de personagem com atributos, traços e sub-raças",
    searchPlaceholder: "Buscar por nome da raça...",
    filters: "Filtros",
    all: "Todas",
    ...
    races: "raças",
    of: "de",
    noResults: "Nenhuma raça corresponde aos filtros.",
