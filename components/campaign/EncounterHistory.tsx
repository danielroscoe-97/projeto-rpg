...
function EncounterCardSkeleton() {
  return (
    <div className="animate-pulse bg-card border border-border rounded-lg p-4 space-y-3" aria-hidden="true">
...
function EncounterCard({ encounter }: { encounter: FinishedEncounter }) {
  ...
  return (
    <div
      className="bg-card border border-border rounded-lg transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-gold/30"
