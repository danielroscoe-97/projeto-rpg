...
export function FloatingCardContainer() {
  ...
  useEffect(() => {
    ...
    function handleClickOutside(e: MouseEvent) {
      ...
      // Ignore clicks on search/compendium buttons, grid cards, and player bottom bar controls
      if (target.closest('[data-testid^="quick-search"]') ||
          target.closest('[data-testid^="compendium-browser"]') ||
          target.closest('[data-testid^="player-bottom-bar"]') ||
          target.closest('.compendium-card')) return;
